...
func (mg *PolicyDhcpV4StaticBinding) GetTerraformResourceType() string {
	return "nsxt_policy_dhcp_v4_static_binding"
}
...
// LateInitialize this PolicyDhcpV4StaticBinding using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *PolicyDhcpV4StaticBinding) LateInitialize(attrs []byte) (bool, error) {
	params := &PolicyDhcpV4StaticBindingParameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
...
func (mg *PolicyDhcpV6StaticBinding) GetTerraformResourceType() string {
	return "nsxt_policy_dhcp_v6_static_binding"
}
...
// LateInitialize this PolicyDhcpV6StaticBinding using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *PolicyDhcpV6StaticBinding) LateInitialize(attrs []byte) (bool, error) {
	params := &PolicyDhcpV6StaticBindingParameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
