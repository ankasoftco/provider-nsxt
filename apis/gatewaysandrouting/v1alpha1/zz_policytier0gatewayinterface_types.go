...
// PolicyTier0GatewayInterface is the Schema for the PolicyTier0GatewayInterfaces API. <no value>
...
func init() {
	SchemeBuilder.Register(&PolicyTier0GatewayInterface{}, &PolicyTier0GatewayInterfaceList{})
}
